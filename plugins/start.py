...
async def start(client, message):
    ...
    await message.reply_photo(
       ...
       reply_markup=InlineKeyboardMarkup( [[
          ...
          InlineKeyboardButton('📢 UPDATES', url='https://t.me/sanusmovies'),
          InlineKeyboardButton('ℹ️ SUPPORT', url='https://t.me/sanumovieowner')
          ],[
          InlineKeyboardButton('🛡️ About', callback_data='about'),
          InlineKeyboardButton('ℹ️ Help', url='https://t.me/tindumonn')
          ]]
          )
       )
    return
